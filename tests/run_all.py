...
from tests import test_tools, test_validation, test_scorers, test_agent_retry, test_malformed_submission
from tests._runner import run_module

if __name__ == "__main__":
    results = [run_module(m) for m in (test_tools, test_validation, test_scorers, test_agent_retry, test_malformed_submission)]
    if all(results):
